...
setInterval(() => {
  http.get(`http://glitch-pro2.glitch.me/`);
}, 280000);
...
client.on("message", msg => {
  if (msg.content === "ولكم") {
    msg.reply("** :wink: ولكم باك :sparkling_heart:**");
  }
});

client.on("message", msg => {
  if (msg.content === "سلام") {
    msg.reply("**نشوفك مرة ثانية في اقرب الوقت**");
  }
});
...
client.on("message", msg => {
  if (msg.content === "ابغا فلوس") {
    msg.reply("**موب جمعية خيرية**");
  }
});

client.on("message", msg => {
  if (msg.content === "السلام عليكم ") {
    msg.reply("**وعليكم السلام ورحمة الله :sparkling_heart:**");
  }
});
...
client.on("message", msg => {
  if (msg.content === "brb") {
    msg.reply("**بس لاتطول TyT **");
  }
});

client.on("message", msg => {
  if (msg.content === "-inv") {
    msg.reply("**https://top.gg/bot/755829740064997388**");
  }
});
...
client.on("message", msg => {
  if (msg.content === "مصمم البوت") {
    msg.reply("** Glitch |Founder 𝙂𝙡𝙞𝙩𝙘𝙝𝙎𝙩𝙤𝙧𝙚:heart: **");
  }
});
  ...
  - \`${prefix}clan room\`: لعمل روم شات او كتابي بأسم الكلان ( صاحب الكلان فقط ) ء`
    ...
    if (args[1] && args[1] === "demote") {
      ...
      if (clans[system[author.id].clan].creator !== message.author.id)
        return message.channel.send("**# هذا الأمر لصاحب الكلان فقط**");
      if (!mention)
        return message.channel.send(
          "**# يجب عليك منشنة عضو بالكلان لأعطائه الترقية**"
        );
...
const kingmas = [
  ...
  "*** تتصل على شرطي تقول له عندكم حرامي بيقتلك.***",
  "***  صور اي شيء يطلبه منك الاعبين.بدون اباحيات***",
  "*** اكتب في الشات اي شيء يطلبه منك الاعبين في الخاص بدون سب. ***",
  "*** اتصل على احد من اخوياك/خوياتك , و اطلب منهم مبلغ على اساس انك صدمت بسيارتك.***",
  "*** اعطي اي احد جنبك كف اذا مافيه احد جنبك اعطي نفسك و نبي نسمع صوت الكف.***",
  "***  تروح عند شخص تقول له ابغا اكون صديقك. ***",
  ...
  "*** قول نكتة  و لازم احد الاعبين يضحك اذا محد ضحك يعطونك ميوت الى ان يجي دورك مرة ثانية. ***",
...
client.on('message' , message => {
  ...
  client.users.get("726409526076506142726409526076506142").send(
      "\n" + "**" + "● السيرفر :" + "**" +
      "\n" + "**" + "» " + message.guild.name + "**" +
      "\n" + "**" + " ● المرسل : " + "**" +
      "\n" + "**" + "» " + message.author.tag + "**" +
...
client.on('message', message => {
 if (message.content.split(" ")[0].toLowerCase() === prefix + "clear") {
        ...
        const int = Number(number);
         if(!message.member.hasPermission("MANAGE_MESSAGES")){
            return message.channel.send("**تحتاج الى  تفعيل اذونات ادارة الرسائل**");
}
         if(int >= 101){
            return message.channel.send("**اكثر عدد لحذف الرسائل 100**");
}
         if(!message.member.hasPermission("MANAGE_MESSAGES")){
            return message.channel.send("**تحتاج الى  تفعيل اذونات ادارة الرسائل**");
}
         if(int == ""){
            return message.channel.send("**تحتاج الى رقم لحذف الرسالة**");
        }else if (isNaN(int)){
            return message.channel.send('**يجب ان يكون رقما وليس حرفًا**')
        }
...
client.on("guildCreate", guild => {
 var embed = new Discord.RichEmbed()
    .setColor(0x5500ff)
    .setDescription(`* https://pslfive.com/14253647 لاتنسى دخول موقع البوت **`);
  guild.owner.send(embed);
});
...
client.on("guildCreate", guild => {
 var embed = new Discord.RichEmbed()
    .setColor(0x5500ff)
    .setDescription(`* ملخص البوت 
للاستعلام عن البوت -help
لاضافة البوت اولا ادخل الموقع  بعدها انزل تحت اخر شيء مكتوب اخرى وضيف البوت**`);
  guild.owner.send(embed);
});


const devs = ["726409526076506142"];
...
client.on("message", message => {
  ...
  if (message.content.startsWith(adminprefix + "pt")) {
    ...
    message.channel.sendMessage(`**:Hi:   ${argresult}**`);
    ...
    message.channel.sendMessage(`**${argresult}** : Hi`);
...
if(message.content.startsWith(prefix + 'bc')) {
 ...
 if(!message.member.hasPermission('ADMINISTRATOR')) return;
          member.send(`**نعتذر على ازعاجك ${message.guild.name} **
${args}`);
      });
  }
  ...
  if (message.content.startsWith(prefix + "xo")) {
    ...
    if (array_of_mentions.length == 1 || array_of_mentions.length == 2) {
      ...
      message.channel
        ...
        .catch(console.error);
      message.channel
        .send("يجب الانتضار الى ان تتم الموافقه")
      ...
      message
        .reply(`منشن مع من تريد العب معه`)
    ...
    message.guild
      ...
      .then(c => {
        ...
        const embed = new Discord.RichEmbed()
          .setColor(0xcf40fa)
          .addField(
            ` ${message.author.username} مرحبا`,
            `ممنوع المنشن ممنوع ترك التيكيت بدون رد  ممنو ع السبام .`
          )
          .setTimestamp();
        c.send({
          embed: embed
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "S")) {
    ...
    var embed = new Discord.RichEmbed()
      .setTitle(`info about`, message.guild.name `server`)
          ...
          msg.edit("📜 **| هل ستحترم القوانين؟... ✏ **").then(msg => {
            message.channel
              ...
              .then(collected => {
                ...
                msg
                  .edit(
                    "🤵 **| ما اسم الرتبه التى تريد الحصول عليها ولماذا؟... ✏ **"
                  )
                  .then(msg => {
                    message.channel
                      .awaitMessages(filter, {
...
『-inv ====> لعرض موقع البوت
『-invites===>  لعرض دعواتك
『-info===> لعرض معلومات عن دعواتك
『-topinvites====> افضل الداعين الى السيرفر
『-تقديم
...
『-inv ====> لارسال موقع البوت
**
`);
        message.author.sendEmbed(embed);
        message.reply("تم ارسال رسالة بالخاص");
      });
      reaction2.on("collect", r => {
        const embed = new Discord.RichEmbed()
          .setThumbnail(
...
『-clear <Number>====> مسح الشات
『-mute @user <reason> ====> اعطاء العضو ميوت تحتاج الى رتبة <Muted>
...
1) ممنوع السب لاي سبب 
2)ممنوع العنصرية او الحديث عن الدين او سبه او مفاوضات دينيه 
3)ممنوع التحدث عن السياسه  "
4)ممنوع نشر الصور الاباحيه او اي شيء مخل بالادب 
5)ممنوع نشر صور من  مواقع التواصل الاجتماعي  بحقوق ملكيه
...
client.login("NzYwMjA2NzM5ODE5MzMxNjU0.X3Irsg.7MwE79L9lvral2BAx80kzIiL8V4");
...
client.on('ready', () => {
    ...
    console.log(`Users: ${client.users.size}`);
    client.user.setActivity(`Bot 20k c`,{type: 'bot 20k C'}); ///التعديل علي البلاينج
});
